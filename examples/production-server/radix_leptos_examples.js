...
export function start_pagination_examples() {
    wasm.start_pagination_examples();
}

export function start_list_examples() {
    wasm.start_list_examples();
}

export function start_timeline_examples() {
    wasm.start_timeline_examples();
}

export function start_toast_examples() {
    wasm.start_toast_examples();
}

export function start_alert_examples() {
    wasm.start_alert_examples();
}

export function start_badge_examples() {
    wasm.start_badge_examples();
}

export function start_avatar_examples() {
    wasm.start_avatar_examples();
}

export function start_image_examples() {
    wasm.start_image_examples();
}

export function start_video_examples() {
    wasm.start_video_examples();
}

export function start_audio_examples() {
    wasm.start_audio_examples();
}

export function start_carousel_examples() {
    wasm.start_carousel_examples();
}

export function start_context_menu_examples() {
    wasm.start_context_menu_examples();
}

export function start_dropdown_menu_examples() {
    wasm.start_dropdown_menu_examples();
}

export function start_menubar_examples() {
    wasm.start_menubar_examples();
}

export function start_scroll_area_examples() {
    wasm.start_scroll_area_examples();
}

export function start_tabs_examples() {
    wasm.start_tabs_examples();
}

export function start_component_showcase() {
    wasm.start_component_showcase();
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbindgen_closure_wrapper7909 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 2651, __wbg_adapter_26);
        return ret;
    };
    imports.wbg.__wbindgen_closure_wrapper7916 = function(arg0, arg1, arg2) {
        const ret = makeMutClosure(arg0, arg1, 2654, __wbg_adapter_26);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('radix_leptos_examples_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
